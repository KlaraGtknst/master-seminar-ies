...
The cosine distance is a measure of the angle between two vectors and does not consider the magnitude.
Therefore, the use of cosine distance to measure the similarity between samples appears questionable.
