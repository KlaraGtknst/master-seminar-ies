...
% AE instead of CNN
% TODO: CNNs and Autoencoders are not mutaly exclusive. Since CNNs are an architecture and VAEs are a Framework VAEs can be implemented using CNNs. Just a minor note.
...
% cosine similarity
% TODO: deutlicher, dass ein PCA pro cluster
