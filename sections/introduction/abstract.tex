\begin{abstract}
    ...
    Contrastive learning is a self-supervised learning technique that is frequently used in representation learning.
    ...
    This paper reviews different approaches for finding sample pairs in contrastive learning, with a focus on hard sample mining.
