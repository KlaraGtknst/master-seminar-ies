...
Usually, \acp{fn} \cite{grape_2024,curricular_weighting_2024,progcl_2022}, i.e. samples considered negative that belong to the latent class of the anchor,
 can be sampled during hard negative mining. 
Hence, samples of the same class are pushed further apart in the embedding space. 
