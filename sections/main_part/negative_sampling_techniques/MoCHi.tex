...
% TODO: Experimente zum s, s' Verhältnis
...
Given a fixed anchor, firstly, $Q$ is ordered in descending similarity to the anchor representation     % TODO: similarity measure
