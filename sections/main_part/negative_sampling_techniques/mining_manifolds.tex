...
The adjacency matrix consists of the reciprocal $k$ nearest neighbours of each sample to reduce the negative impact of outliers \citet{diffusion_2017,mining_manifolds_2018,fast_2018}.
