...
% backgound neighbours: no better explanation found as to why they are called background neighbours -> own definiton!
...
% construction of Ci and Bi & hyperparameters
...
% In an ablation study, \citeauthor{local_aggr_2019} discover that if $H$ is too high compared to the number of clusters $m$, the performance decreases.
% % m = # clusters, k = # NNs
% They state that $H=3, m=10000$ and $H=10, m=30000$ are better values than $H=10, m=10000$ 
