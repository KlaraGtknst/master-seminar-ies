...
is drawn from the data distribution $p$, \cite{robinson_contrastive_2021} 
...
The authors of \cite{robinson_contrastive_2021} propose negative samples from $q^-_{\beta}(x^-)$, 
