...
% other work
% EM-algorithm
Multiple approaches, including \ac{drc}, \ac{pcl} and \ac{progcl}, use the \ac{em} algorithm 
to reduce computational costs or to find solutions via approximations.
Both \ac{drc} \citet{DRC_2020} and \ac{progcl} \citet{PCL_2021} are clustering-based methods 
while \ac{progcl} \citet{progcl_2022} is a distribution-based method.
